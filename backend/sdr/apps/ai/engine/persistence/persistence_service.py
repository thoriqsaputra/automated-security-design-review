        ...
        *,
        ...
        try:
            ...
            with SessionLocal() as db:
                ...
                finding.vision_thought_process = self._strip_null_bytes(hunter_result.get("cot_trace"))
                ...
                # Real chain-of-thought — generated by every vision agent via the same
                # reasoning schema as text findings, but previously discarded here.
                finding.hunter_thought_process = self._strip_null_bytes(hunter_result.get("cot_trace"))
                finding.critic_thought_process = self._strip_null_bytes(critic_result.get("cot_trace"))
                finding.mediator_thought_process = self._strip_null_bytes(mediator_result.get("cot_trace"))
