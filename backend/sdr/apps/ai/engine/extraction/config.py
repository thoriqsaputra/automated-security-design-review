...
class ExtractionConfig:
    ...
    standard_extraction_chunk_overlap_tokens: int = 600
    ...
    def from_settings(cls) -> "ExtractionConfig":
        return cls(
            ...
            standard_extraction_chunk_overlap_tokens=max(
                0,
                int(getattr(settings, "AI_STANDARD_EXTRACTION_CHUNK_OVERLAP_TOKENS", 600)),
            ),
        )
