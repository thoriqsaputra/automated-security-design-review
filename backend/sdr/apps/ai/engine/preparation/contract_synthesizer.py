...
from sdr.apps.ai.engine.classification.domain_classification import classify_requirement_domain
...
class ContractSynthesizer:
    ...
    def _llm_fallback(
        ...
        try:
            user_prompt = build_contract_synthesis_prompt(
            ...
            response = chat_completion(
                messages=[
                    {"role": "system", "content": CONTRACT_SYNTHESIS_SYSTEM_PROMPT},
            ...
            try:
                ...
                repair_prompt = build_contract_repair_prompt((response.content or "").strip())
